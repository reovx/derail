...
/**
 * The console home — `SPEC-UI-UX.md` §5.1.
 *
 * One route, two states. A project with no recorded runs gets the argument; a
 * project with runs gets the console. The public front door now lives at `/`;
 * this is where the rail's "Overview" lands, for people already inside.
 *
